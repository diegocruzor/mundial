...
<html>
	...
	<body onLoad="Reloj()">    	<font face="Verdana, Geneva, sans-serif">
		<center>
...
?>		
        ...
        <table border="0" bgcolor="#C4300B" style="font-family:'Comic Sans MS', cursive; font-size:24px;">
            <tr>
            	<td align="center" width="150px">
<?php
					$sql10 = "SELECT * FROM puntajes WHERE IdParticipante = '".$_SESSION["i"]."'";
					$r10 = mysqli_query($xcon, $sql10);
					if ($puntajes = mysqli_fetch_array($r10, MYSQLI_ASSOC)) echo "<font color='#FFFFFF'><strong>Mis Puntos:<br>".$puntajes["Puntos"]."</strong></font>";
?>            
            	</td>
            </tr> 
		</table><br>
...
<br><font face="Trebuchet MS, Arial, Helvetica, sans-serif" size="2">Realizado por Diego Cruz &copy</font>
		</center>
    	</font>
    </body>
</html>	